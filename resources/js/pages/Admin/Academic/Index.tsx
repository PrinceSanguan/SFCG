                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <Card>
                                ...
                                <CardContent>
                                    <Link href={route('admin.academic.levels')}><Button variant="outline">Manage Levels</Button></Link>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardHeader><CardTitle>Add/Edit grading periods or semesters</CardTitle></CardHeader>
                                <CardContent>
                                    <Link href={route('admin.academic.grading')}><Button variant="outline">Manage Grading</Button></Link>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardHeader><CardTitle>Manage strands, courses, and departments</CardTitle></CardHeader>
                                <CardContent>
                                    <Link href={route('admin.academic.programs')}><Button variant="outline">Manage Programs</Button></Link>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardHeader><CardTitle>Assign instructors (College)</CardTitle></CardHeader>
                                <CardContent>
                                    <Link href={route('admin.academic.assign-instructors')}><Button variant="outline">Assign Instructors</Button></Link>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardHeader><CardTitle>Assign teachers (SHS)</CardTitle></CardHeader>
                                <CardContent>
                                    <Link href={route('admin.academic.assign-teachers')}><Button variant="outline">Assign Teachers</Button></Link>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardHeader><CardTitle>Assign class advisers (Elementary to JHS)</CardTitle></CardHeader>
                                <CardContent>
                                    <Link href={route('admin.academic.assign-advisers')}><Button variant="outline">Assign Advisers</Button></Link>
                                </CardContent>
                            </Card>
                            <Card>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <Link href={route('admin.academic.student-subjects.index')}><Button variant="outline">Manage Student Subjects</Button></Link>
                                </CardContent>
                            </Card>
                        </div>
                    </div>
