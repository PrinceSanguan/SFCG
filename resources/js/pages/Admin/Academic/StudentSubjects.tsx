...
export default function StudentSubjects({ 
    ...
    const submitAssignment = (e: React.FormEvent) => {
        e.preventDefault();
        router.post('/admin/academic/student-subjects', assignmentForm);
    ...
    const updateAssignment = (e: React.FormEvent) => {
        ...
        router.put(`/admin/academic/student-subjects/${editAssignment.id}`, {
            ...assignmentForm,
    ...
    const destroyAssignment = (id: number) => {
        if (confirm('Are you sure you want to remove this student subject enrollment?')) {
            router.delete(`/admin/academic/student-subjects/${id}`);
        }
    };
