...
const JuniorHighGrading: React.FC<Props> = ({ 
    grades, 
    academicPeriods, 
    subjects, 
    instructors, 
    ...
    const handleFilter = () => {
        router.get('/admin/grading/junior-high', data, {
            preserveState: true,
            preserveScroll: true,
        });
    };
    ...
    return (
        <>
            <Head title="Junior High School Grading" />
            <AdminLayout>
                <div className="mb-8">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">Junior High School Grading</h1>
                            <p className="text-gray-600 mt-2">Manage grades for Junior High School students (Grades 7-10)</p>
                        </div>
                        <Link
                            href="/admin/grading"
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                    <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                        <h2 className="text-lg font-semibold text-gray-900">Junior High School Grades</h2>
                        <div className="flex items-center space-x-4">
                            <Link
                                href="/admin/grading/junior-high/create"
                    ...
                    {grades.data.length === 0 ? (
                        <div className="p-12 text-center text-gray-500">
                            ...
                            <h3 className="text-lg font-medium text-gray-900 mb-2">No junior high school grades found</h3>
                    ...
                    <div className="mt-6 flex items-center justify-between">
                        ...
                        <div className="flex space-x-2">
                            {grades.current_page > 1 && (
                                <Link
                                    href={`/admin/grading/junior-high?page=${grades.current_page - 1}`}
...
export default JuniorHighGrading; 