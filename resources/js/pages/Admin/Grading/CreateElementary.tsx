...
const CreateElementary: React.FC<Props> = ({ students, subjects, academicPeriods, instructors }) => {
    ...
    return (
        <>
            <Head title="Create Elementary Grade" />
            <AdminLayout>
                <div className="mb-8">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">Create Elementary Grade</h1>
                            <p className="text-gray-600 mt-2">Add new grades for Elementary students (Grades 1-6)</p>
                        </div>
                        <Link
                            href="/admin/grading/elementary"
                            className="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition-colors"
                        >
                            ← Back to Elementary Grades
                        </Link>
                    </div>
                </div>
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            {selectedStudent && (
                                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                                    <h3 className="text-sm font-medium text-green-800 mb-2">Student Information</h3>
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-green-800">{selectedStudent.student_profile.student_id}</p>
                                        </div>
                                        <div>
                                            <span className="text-green-700 font-medium">Grade Level:</span>
                                            <p className="text-green-800">Grade {selectedStudent.student_profile.grade_level}</p>
                                        </div>
                                        <div>
                                            <span className="text-green-700 font-medium">Section:</span>
                                            <p className="text-green-800">{selectedStudent.student_profile.section}</p>
                                        </div>
                                    </div>
                                </div>
                            )}
                            ...
                            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <h3 className="text-lg font-medium text-green-800">Final Grade</h3>
                                        <p className="text-sm text-green-600">Automatically calculated based on quarterly grades</p>
                                    </div>
...
export default CreateElementary; 