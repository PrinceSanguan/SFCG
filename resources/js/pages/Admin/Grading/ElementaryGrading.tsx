...
const ElementaryGrading: React.FC<Props> = ({ 
    grades, 
    academicPeriods, 
    subjects, 
    instructors, 
    ...
    const handleFilter = () => {
        router.get('/admin/grading/elementary', data);
    };
            ...
            <AdminLayout>
                <div className="p-6">
                    ...
                    <div className="flex items-center space-x-3 mb-6">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">Elementary Grading</h1>
                            <p className="text-gray-600">Manage grades for Elementary level (Grades 1-6)</p>
                        </div>
                    </div>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex space-x-2">
                                        {grades.current_page > 1 && (
                                            <Link
                                                href={`/admin/grading/elementary?page=${grades.current_page - 1}`}
...
export default ElementaryGrading; 