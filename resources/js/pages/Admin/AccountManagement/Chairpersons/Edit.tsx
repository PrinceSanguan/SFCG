...
export default function EditChairperson({ user, targetUser, roles, errors }: EditProps) {
    ...
    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        put(route('admin.chairpersons.update', targetUser.id));
    };
                ...
                <main className="flex-1 overflow-y-auto bg-gray-100 p-4 md:p-6 dark:bg-gray-900">
                    <div className="flex flex-col gap-6">
                        <div className="flex items-center gap-4">
                            <Link href={route('admin.chairpersons.index')}>
                                <Button variant="outline" size="sm" className="flex items-center gap-2">
                                    <ArrowLeft className="h-4 w-4" />
                                    Back to Chairpersons
                                </Button>
                            </Link>
                            <div>
                                <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Edit Chairperson</h1>
                                <p className="text-gray-500 dark:text-gray-400">
                                    Update chairperson information and role assignments.
                                </p>
                            </div>
                        </div>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="flex gap-4">
                                    <Link href={route('admin.chairpersons.show', targetUser.id)}>
                                        ...
                                        <Button 
                                            ...
                                            onClick={() => {
                                                if (confirm('Are you sure you want to delete this user? This action cannot be undone.')) {
                                                    router.delete(route('admin.chairpersons.destroy', targetUser.id), {
                                                        onSuccess: () => {
                                                            // Redirect to chairpersons list after successful deletion
                                                            router.visit(route('admin.chairpersons.index'));
                                                        },
                                                        onError: (errors) => {
