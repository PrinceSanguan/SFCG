...
export default function AccountManagementList({ user, users, filters, roles }: ListProps) {
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col gap-2">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">
                                Manage user accounts across all roles in the school system.
                            </p>
                        </div>
                                                ...
                                                <tr key={tableUser.id} className="border-b hover:bg-gray-50 dark:hover:bg-gray-800">
                                                    ...
                                                    <td className="p-3">
                                                        <div className="flex items-center gap-2">
                                                            <Link href={route('admin.users.show', tableUser.id)}>
                                                                <Button variant="outline" size="sm">
                                                                    <Eye className="h-3 w-3" />
                                                                </Button>
                                                            </Link>
                                                            <Link href={route('admin.users.edit', tableUser.id)}>
                                                                <Button variant="outline" size="sm">
