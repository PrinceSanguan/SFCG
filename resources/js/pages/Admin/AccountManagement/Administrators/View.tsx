...
export default function AdministratorView({ user, targetUser, activityLogs }: ViewProps) {
                ...
                <main className="flex-1 overflow-y-auto bg-gray-100 p-4 md:p-6 dark:bg-gray-900">
                    <div className="flex flex-col gap-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Administrator Profile</h1>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="flex gap-4">
                                    <Link href={route('admin.administrators.edit', targetUser.id)}>
                            ...
                            <CardContent>
                                {activityLogs.data.length > 0 ? (
                                            ...
                                            <div className="mt-6 flex items-center justify-between">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    {activityLogs.current_page > 1 && (
                                                        <Link 
                                                            href={route('admin.administrators.show', { 
                                                                user: targetUser.id, 
                                    ...
                                    <div className="text-center py-8">
                                        ...
                                        <p className="text-gray-500 dark:text-gray-400">No activity logs found for this administrator.</p>
                                    </div>
                                )}
                            </CardContent>
                        </Card>
