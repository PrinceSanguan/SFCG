...
export default function AdministratorEdit({ user, targetUser, roles, errors }: EditProps) {
    ...
    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        put(route('admin.administrators.update', targetUser.id));
    };
                ...
                <main className="flex-1 overflow-y-auto bg-gray-100 p-4 md:p-6 dark:bg-gray-900">
                    <div className="flex flex-col gap-6">
                        <div className="flex items-center gap-4">
                            <Link href={route('admin.administrators.index')}>
                            ...
                            <div>
                                <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Edit Administrator</h1>
                                <p className="text-gray-500 dark:text-gray-400">
                                    Update administrator information and role assignments.
                                </p>
                            </div>
                        </div>
                        ...
                        <Card>
                            <CardHeader>
                                <CardTitle>Current Administrator Information</CardTitle>
                            </CardHeader>
                            <CardContent>
                        ...
                        <Card>
                            <CardHeader>
                                <CardTitle>Update Administrator Information</CardTitle>
                            </CardHeader>
                            <CardContent>
                            ...
                            <CardContent>
                                <div className="space-y-4">
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                        Reset the administrator's password to allow them to regain access to their account. 
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="flex gap-4">
                                    <Link href={route('admin.administrators.show', targetUser.id)}>
                                        ...
                                        <Button 
                                            ...
                                            onClick={() => {
                                                if (confirm('Are you sure you want to delete this administrator? This action cannot be undone.')) {
                                                    router.delete(route('admin.administrators.destroy', targetUser.id));
                                                }
                                            }}
                                        >
