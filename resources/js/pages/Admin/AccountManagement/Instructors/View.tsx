...
interface ViewProps {
    ...
    instructorSubjectAssignments: InstructorSubjectAssignment[];
    assignedStudents: AssignedStudent[];
    currentSchoolYear: string;
}

export default function ViewInstructor({ user, targetUser, activityLogs, instructorSubjectAssignments, assignedStudents, currentSchoolYear }: ViewProps) {
            ...
            <div className="flex flex-1 flex-col overflow-hidden">
                ...
                <main className="flex-1 overflow-y-auto bg-gray-100 p-4 md:p-6 dark:bg-gray-900">
                    <div className="flex flex-col gap-6">
                        ...
                        {instructorSubjectAssignments && instructorSubjectAssignments.length > 0 && (
                            <Card>
                                <CardHeader>
                                    <CardTitle className="flex items-center gap-2">
                                ...
                                <CardContent>
                                    <div className="space-y-4">
                                        {instructorSubjectAssignments.map((assignment) => (
