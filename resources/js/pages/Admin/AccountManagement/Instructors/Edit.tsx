...
export default function EditInstructor({ user, targetUser, roles, errors }: EditProps) {
    ...
    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        put(route('admin.instructors.update', targetUser.id));
    };
                ...
                <main className="flex-1 overflow-y-auto bg-gray-100 p-4 md:p-6 dark:bg-gray-900">
                    <div className="flex flex-col gap-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Edit Instructor</h1>
                                <p className="text-gray-500 dark:text-gray-400">
                                    Update instructor information and role assignments.
                                </p>
                            </div>
                        </div>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="flex gap-4">
                                    <Link href={route('admin.instructors.show', targetUser.id)}>
                                        ...
                                        <Button 
                                            ...
                                            onClick={() => {
                                                if (confirm('Are you sure you want to delete this user? This action cannot be undone.')) {
                                                    router.delete(route('admin.instructors.destroy', targetUser.id), {
                                                        onSuccess: () => {
                                                            // Redirect to instructors list after successful deletion
                                                            router.visit(route('admin.instructors.index'));
                                                        },
                                                        onError: (errors) => {
