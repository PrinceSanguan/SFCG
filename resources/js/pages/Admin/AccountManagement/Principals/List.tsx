...
export default function PrincipalsList({ user, users, filters, roles }: ListProps) {
    ...
    const handleSearch = () => {
        router.get(route('admin.principals.index'), {
            search: searchTerm,
            role: selectedRole,
        }, {
            preserveState: true,
    ...
    const handleDelete = (userId: number) => {
        if (confirm('Are you sure you want to delete this principal? This action cannot be undone.')) {
            router.delete(route('admin.principals.destroy', userId), {
                onSuccess: () => {
                ...
                <main className="flex-1 overflow-y-auto bg-gray-100 p-4 md:p-6 dark:bg-gray-900">
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col gap-2">
                            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Principals Management</h1>
                            <p className="text-gray-500 dark:text-gray-400">
                                Manage principal accounts in the school system.
                            </p>
                        </div>
                        ...
                        <Card>
                            <CardContent className="p-4">
                                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                                    ...
                                    <Link href={route('admin.principals.create')}>
                                                ...
                                                <tr key={tableUser.id} className="border-b hover:bg-gray-50 dark:hover:bg-gray-800">
                                                    ...
                                                    <td className="p-3">
                                                        <div className="flex items-center gap-2">
                                                            <Link href={route('admin.principals.show', tableUser.id)}>
                                                                <Button variant="outline" size="sm">
                                                                    <Eye className="h-3 w-3" />
                                                                </Button>
                                                            </Link>
                                                            <Link href={route('admin.principals.edit', tableUser.id)}>
                                                                <Button variant="outline" size="sm">
                                    ...
                                    <div className="mt-4 flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2">
                                            {users.current_page > 1 && (
                                                <Link 
                                                    href={route('admin.principals.index', { ...filters, page: users.current_page - 1 })}
                                                >
