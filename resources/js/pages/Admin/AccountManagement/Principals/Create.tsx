...
export default function CreatePrincipal({ user, currentRole, errors }: CreateProps) {
    ...
    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        post(route('admin.principals.store'));
    };
                ...
                <main className="flex-1 overflow-y-auto bg-gray-100 p-4 md:p-6 dark:bg-gray-900">
                    <div className="flex flex-col gap-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Create New Principal</h1>
                                <p className="text-gray-500 dark:text-gray-400">
                                    Add a new principal to the school management system.
                                </p>
                            </div>
                        </div>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div className="flex items-center gap-4 pt-6">
                                        <Button type="submit" disabled={processing} className="flex items-center gap-2">
                                            ...
                                            {processing ? 'Creating...' : 'Create Principal'}
                                        </Button>
                                        <Link href={route('admin.principals.index')}>
