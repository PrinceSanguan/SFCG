...
import { Search, Plus, Edit, Eye, Trash2, RotateCcw, BookOpen } from 'lucide-react';
...
export default function TeacherList({ user, users, filters }: TeacherListProps) {
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col gap-2">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">
                                Manage teacher accounts and their classroom access.
                            </p>
                        </div>
                                    ...
                                    <div className="mt-4 flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2">
                                            {users.current_page > 1 && (
                                                <Link 
                                                    href={route('admin.teachers.index', { ...filters, page: users.current_page - 1 })}
                                                >
