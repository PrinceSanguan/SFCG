...
export default function TeacherHonorsShowByLevel({ user, academicLevel, honorResults, transformedResults, honorTypes, schoolYear, levelStats }: Props) {
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <Link href={route('teacher.honors.index')}>
