...
const TeacherProfile: React.FC<Props> = ({ teacher }) => {
                        ...
                        <div className="p-6">
                            <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                                <div>
                                    ...
                                    <dd className="mt-1 text-sm text-gray-900">{teacher.role_display}</dd>
                                </div>
                                <div>
                                    <dt className="text-sm font-medium text-gray-500">Account Created</dt>
                                    <dd className="mt-1 text-sm text-gray-900">{teacher.created_at}</dd>
                                </div>
                                <div>
                                    <dt className="text-sm font-medium text-gray-500">Last Login</dt>
                                    <dd className="mt-1 text-sm text-gray-900">{teacher.last_login_at}</dd>
                                </div>
                                <div>
