...
const AcademicPeriods: React.FC<Props> = ({ periodsByLevel, levels }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (editingPeriod) {
            put(`/registrar/academic/periods/${editingPeriod.id}`, {
                onSuccess: () => {
            ...
            post('/registrar/academic/periods', {
                onSuccess: () => {
    ...
    const handleDelete = (period: AcademicPeriod) => {
        if (confirm(`Are you sure you want to delete ${period.name}? This action cannot be undone.`)) {
            router.delete(`/registrar/academic/periods/${period.id}`);
        }
    };
    ...
    return (
        <RegistrarLayout>
            <Head title="Academic Periods - Registrar" />
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-gray-900">Academic Periods</h1>
                <p className="text-gray-600 mt-2">Configure academic periods by education level</p>
            </div>
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                        <div className="px-6 py-4 border-b border-gray-200">
                            <h3 className="text-lg font-medium text-gray-900">
                                {level.name} Periods List ({periods.length})
                            </h3>
                        </div>
