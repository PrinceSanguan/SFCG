...
const AcademicPeriods: React.FC<Props> = ({ periods }) => {
        ...
        <RegistrarLayout>
            <Head title="Academic Periods - Registrar" />
                            ...
                            <div className="mb-8">
                                ...
                                <p className="text-gray-600 mt-2">Configure academic periods, semesters, and quarters</p>
                            </div>
                            ...
                            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                                <div className="px-6 py-4 border-b border-gray-200">
                                    <h3 className="text-lg font-medium text-gray-900">
                                        Academic Periods List ({periods.length})
                                    </h3>
                                </div>
