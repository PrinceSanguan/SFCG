...
export default function AssignInstructors({ user, assignments, instructors, departments, courses, sections, subjects, gradingPeriods, academicLevels, yearLevels }: Props) {
    ...
    useEffect(() => {
        ...
        if (assignmentForm.course_id) {
            ...
            console.log('[REGISTRAR] Filtering sections:', {
        ...
        if (assignmentForm.section_id && sectionJustSelected) {
            ...
            if (selectedSection) {
                ...
                console.log('[REGISTRAR] Filtering subjects by section:', {
                            ...
                            <div>
                                ...
                                <Select
                                    ...
                                    onValueChange={(value) => {
                                        ...
                                        console.log('[REGISTRAR] sectionJustSelected set to TRUE - Subject should now appear');
                                    }}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <Select
                                    value={assignmentForm.course_id}
                                    onValueChange={(value) => {
                                        console.log('[REGISTRAR EDIT] Course changed to:', value);
                                        setAssignmentForm({ ...assignmentForm, course_id: value, section_id: '', subject_id: '' });
                                        setSectionJustSelected(false);
                                        console.log('[REGISTRAR EDIT] sectionJustSelected reset to false (course changed)');
                                    }}
                                    required
                                    disabled={!assignmentForm.department_id}
                                >
