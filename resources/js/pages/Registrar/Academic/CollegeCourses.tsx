...
const CollegeCourses: React.FC<Props> = ({ courses, degreeTypes }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (editingCourse) {
            put(`/registrar/academic/college-courses/${editingCourse.id}`, {
                onSuccess: () => {
            ...
            post('/registrar/academic/college-courses', {
                onSuccess: () => {
    ...
    const handleDelete = (course: CollegeCourse) => {
        if (confirm(`Are you sure you want to delete ${course.name}? This action cannot be undone.`)) {
            router.delete(`/registrar/academic/college-courses/${course.id}`);
        }
    };
    ...
    return (
        <>
            <Head title="Course Programs - Registrar" />
                ...
                <div className="flex">
                    ...
                    <main className="flex-1 p-8">
                        <div className="max-w-7xl mx-auto">
                            {/* Header */}
                            <div className="mb-8">
                                <h1 className="text-3xl font-bold text-gray-900">Course Programs</h1>
                                <p className="text-gray-600 mt-2">Manage course programs and degree offerings</p>
                            </div>
                            ...
                            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                                <div className="px-6 py-4 border-b border-gray-200">
                                    <h3 className="text-lg font-medium text-gray-900">
                                        College Courses List ({courses.length})
                                    </h3>
                                </div>
                                            ...
                                            <form onSubmit={handleSubmit} className="space-y-4">
                                                ...
                                                <div>
                                                    ...
                                                    <select
                                                        ...
                                                        required
                                                    >
                                                        {Object.entries(degreeTypes).map(([key, value]) => (
                                                ...
                                                <div>
                                                    ...
                                                    <textarea
                                                        ...
                                                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                                        rows={3}
                                                        placeholder="Brief description of this course program"
                                                    />
