                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            <Card>
                                ...
                                <CardContent>
                                    <Link href={route('registrar.academic.sections.elementary')}><Button variant="outline" className="w-full">Open</Button></Link>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardHeader><CardTitle>Junior High School</CardTitle></CardHeader>
                                <CardContent>
                                    <Link href={route('registrar.academic.sections.junior')}><Button variant="outline" className="w-full">Open</Button></Link>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardHeader><CardTitle>Senior High School</CardTitle></CardHeader>
                                <CardContent>
                                    <Link href={route('registrar.academic.sections.senior')}><Button variant="outline" className="w-full">Open</Button></Link>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardHeader><CardTitle>College</CardTitle></CardHeader>
                                <CardContent>
                                    <Link href={route('registrar.academic.sections.college')}><Button variant="outline" className="w-full">Open</Button></Link>
                                </CardContent>
                            </Card>
                        </div>
                    </div>
