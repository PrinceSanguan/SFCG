...
const AcademicLevels: React.FC<Props> = ({ levels }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (editingLevel) {
            put(`/registrar/academic/levels/${editingLevel.id}`, {
                onSuccess: () => {
            ...
            post('/registrar/academic/levels', {
                onSuccess: () => {
    ...
    const handleDelete = (level: AcademicLevel) => {
        if (confirm(`Are you sure you want to delete ${level.name}? This action cannot be undone.`)) {
            router.delete(`/registrar/academic/levels/${level.id}`);
        }
    };
    ...
    return (
        <RegistrarLayout>
            <Head title="Academic Levels - Registrar" />
                            {/* Header */}
                            <div className="mb-8">
                                <h1 className="text-3xl font-bold text-gray-900">Academic Levels</h1>
                                <p className="text-gray-600 mt-2">Configure grade levels and academic structure</p>
                            </div>
                            ...
                            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                                <div className="px-6 py-4 border-b border-gray-200">
                                    <h3 className="text-lg font-medium text-gray-900">
                                        Academic Levels List ({levels.length})
                                    </h3>
                                </div>
