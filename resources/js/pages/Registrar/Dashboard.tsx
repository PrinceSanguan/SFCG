import { Header } from '@/components/registrar/header'; // Import the Header component
import { Sidebar } from '@/components/registrar/sidebar'; // Import the Sidebar component
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
import { Button } from '@/components/ui/button';
import { Link } from '@inertiajs/react';
import { Users, Activity, Shield, GraduationCap, Award, FileText } from 'lucide-react';
...
export default function RegistrarDashboard({ user, stats, recentUsers, recentActivities }: DashboardProps) {
                ...
                <main className="flex-1 overflow-y-auto bg-gray-100 p-4 md:p-6 dark:bg-gray-900">
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col gap-2">
                            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Registrar Dashboard</h1>
                            <p className="text-gray-500 dark:text-gray-400">
                                Welcome back, {user.name}! Manage student records and academic information from here.
                            </p>
                        </div>
                        ...
                        {/* Additional Academic Stats */}
                        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                            <Card>
                                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                    <CardTitle className="text-sm font-medium">Honor Awards</CardTitle>
                                    <Award className="h-4 w-4 text-muted-foreground" />
                                </CardHeader>
                                <CardContent>
                                    <div className="text-2xl font-bold">{stats.total_honors}</div>
                                    <p className="text-xs text-muted-foreground">
                                        Honor roll entries
                                    </p>
                                </CardContent>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="flex gap-4">
                                    ...
                                    <Link href={route('registrar.reports.index')}>
                                        <Button variant="outline" className="flex items-center gap-2">
