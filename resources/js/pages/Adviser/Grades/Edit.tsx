...
export default function Edit({ user, grade, gradingPeriods, assignedSubjects }: EditProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        put(route('adviser.grades.update', grade.id), {
            onSuccess: () => {
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="flex items-center gap-4">
                                <Link href={route('adviser.grades.show-student', [grade.student_id, grade.subject_id])}>
                        ...
                        {/* Edit Window Status - Days Remaining Warning (3-Day Window for Advisers) */}
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className={`text-sm mt-1 ${
                                                ...
                                                {grade.days_remaining === 0
                                                    ? 'This is your last opportunity to edit this grade before the 3-day window expires.'
                                                    : grade.days_remaining === 1
                                                    ? 'You have 1 day left to edit this grade within the 3-day edit window.'
                                                    : `You have ${grade.days_remaining} days left to edit this grade within the 3-day edit window.`}
