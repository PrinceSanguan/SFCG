...
export default function InstructorHonorsIndex({ user, academicLevels, honorTypes, schoolYear, assignedCourses, overallStats }: Props) {
                                ...
                                <Card key={level.id} className="hover:shadow-md transition-shadow">
                                    ...
                                    <CardContent>
                                        <div className="space-y-3">
                                            ...
                                            <Link href={route('instructor.honors.show-by-level', level.id)}>
