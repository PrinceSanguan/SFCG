...
class ElementaryHonorCalculationService
{
    ...
    public function calculateElementaryHonorQualification(int $studentId, int $academicLevelId, string $schoolYear): array
    {
        ...
        \Log::info('[ELEMENTARY HONOR] Grading periods fetched', [
        ...
        \Log::info('[ELEMENTARY HONOR] Grades fetched for student', [
            'student_id' => $studentId,
            'school_year' => $schoolYear,
        ...
        if ($grades->isEmpty()) {
            \Log::warning('[ELEMENTARY HONOR] No grades found for student', [
                'student_id' => $studentId,
                'school_year' => $schoolYear,
        ...
        \Log::info('[ELEMENTARY HONOR] Honor qualification calculated', [
            'student_id' => $studentId,
            'school_year' => $schoolYear,
            'qualifies' => $qualified,
            'average_grade' => $averageGrade,
