...
class RegistrarCertificateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Registrar/Academic/Certificates/Index', [
    ...
    public function generate(Request $request)
    {
        ...
        try {
            ...
            if ($certificate) {
                Log::info('Certificate generated manually by registrar', [
            ...
            Log::error('Registrar certificate generation failed', [
                'student_id' => $studentId,
                'academic_level' => $academicLevel->key,
                'error' => $e->getMessage(),
                'generated_by' => Auth::id(),
    ...
    {
        Log::info('[REGISTRAR_CERTIFICATE_DOWNLOAD] Starting certificate download', [
            'certificate_id' => $certificate->id,
            'serial_number' => $certificate->serial_number,
        ...
        Log::info('[REGISTRAR_CERTIFICATE_DOWNLOAD] Certificate downloaded successfully', [
            'certificate_id' => $certificate->id,
            'serial_number' => $certificate->serial_number,
    ...
    {
        Log::info('[REGISTRAR_CERTIFICATE_PRINT] Starting certificate print', [
            'certificate_id' => $certificate->id,
            'serial_number' => $certificate->serial_number,
            'student_id' => $certificate->student_id,
            'student_name' => $certificate->student->name,
        ...
        Log::info('[REGISTRAR_CERTIFICATE_PRINT] Certificate printed successfully', [
            'certificate_id' => $certificate->id,
            'serial_number' => $certificate->serial_number,
            'orientation' => 'portrait',
        ]);
    ...
    public function bulkPrintPDF(Request $request)
    {
        ...
        Log::info('[REGISTRAR_BULK_CERTIFICATE_DOWNLOAD] Starting bulk certificate download', [
        ...
        if ($certificates->isEmpty()) {
            Log::warning('[REGISTRAR_BULK_CERTIFICATE_DOWNLOAD] No certificates found', [
                'certificate_ids' => $validated['certificate_ids'],
            ]);
        ...
        foreach ($certificates as $index => $certificate) {
            Log::info('[REGISTRAR_BULK_CERTIFICATE_DOWNLOAD] Adding certificate to PDF', [
                'index' => $index + 1,
                'certificate_id' => $certificate->id,
                'serial_number' => $certificate->serial_number,
                'student_name' => $certificate->student->name,
        ...
        Log::info('[REGISTRAR_BULK_CERTIFICATE_DOWNLOAD] Bulk certificates download completed successfully', [
    ...
    public function honorRoll(Request $request)
    {
        ...
        return Inertia::render('Registrar/Academic/Certificates/HonorRoll', [
            'user' => $this->sharedUser(),
            'honorRoll' => $honorRoll,
            'academicLevels' => $academicLevels,
            'honorTypes' => $honorTypes,
