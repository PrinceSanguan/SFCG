...
class HonorTrackingController extends Controller
{
    public function index()
    {
        ...
        // Get teacher's assigned subjects with academic levels
        $assignments = TeacherSubjectAssignment::with(['subject.course', 'academicLevel'])
        ...
        Log::info('[Teacher] Honor Tracking Index - Honor Types Filtered', [
        ...
        // Get honor statistics for teacher's assigned academic levels
    ...
    public function showByLevel(AcademicLevel $academicLevel)
    {
        ...
        $hasAssignment = TeacherSubjectAssignment::where('teacher_id', $user->id)
        ...
        Log::info('[Teacher] Honor Tracking ShowByLevel - Honor Types Filtered', [
            'total_honor_types' => $honorTypes->count(),
            'honor_types' => $honorTypes->pluck('name', 'key')->toArray(),
            'scope' => 'basic',
